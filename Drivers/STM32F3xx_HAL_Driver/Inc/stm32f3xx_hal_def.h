 ...
 * instead of calling HAL_PPP_DeInit() then HAL_PPP_Init(), user can make a
 * call to this macro then HAL_PPP_Init(). In this later function, when the
 * Handle's "State" field is set to 0, it will execute the function
